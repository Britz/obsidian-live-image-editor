#!/usr/bin/env node
// Bug-43 CROP STRUCTURAL CHECK — the runnable, read-DOM-back integration check for the in-place
...
// the CDP relay. Run from the repo root:  node tests/cdp/verify-crop.mjs
...
const EVAL_RUN = `(async () => {
  ...
  try {
    ...
    // --- G: a width edit preserves the crop (drive the real LP resize write path on crop-placement data) ---
