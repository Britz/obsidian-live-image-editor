...
// restored accept (✓) + cancel (✗) icons on the shared host (F14/AD8/D6; test-plan §3, T-L6 — the
...
// the CDP relay. Run from the repo root:  node scripts/verify-submodal-icons.mjs
