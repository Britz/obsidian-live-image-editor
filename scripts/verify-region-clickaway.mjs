#!/usr/bin/env node
// CLICK-AWAY CLOSES THE SUB-PANEL — crop EXEMPT (Bug 1; D6/F14/AD8; test-plan §3, T-L6 — the
...
// the CDP relay. Run from the repo root:  node scripts/verify-region-clickaway.mjs
