#!/usr/bin/env node
// GROUP POPUP ↔ TOOLBAR = ONE REGION, NOT GREYED (Bug 3; D6; test-plan §3, T-L6 — the obsidian/
...
// the CDP relay. Run from the repo root:  node scripts/verify-popup-region.mjs
